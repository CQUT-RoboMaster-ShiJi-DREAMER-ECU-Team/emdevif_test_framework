...
#define GET_THIS_TEST_CASE_CONTEXT        EMDEVIF_TEST_GET_THIS_TEST_CASE_CONTEXT
#define RUN_TEST_CASE_WITHIN_CONTEX_BEGIN EMDEVIF_TEST_RUN_TEST_CASE_WITHIN_CONTEX_BEGIN
#define RUN_TEST_CASE_WITHIN_CONTEX_END   EMDEVIF_TEST_RUN_TEST_CASE_WITHIN_CONTEX_END
